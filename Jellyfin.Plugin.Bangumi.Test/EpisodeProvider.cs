...
namespace Jellyfin.Plugin.Bangumi.Test
{
    ...
    {
        private readonly Providers.EpisodeProvider _provider = new(new TestApplicationPaths(),
        ...
        public async Task FixEpisodeIndexWithoutCount()
        {
            var episodeData = await _provider.GetMetadata(new EpisodeInfo
            {
                ...
                ProviderIds = new Dictionary<string, string> {{Constants.ProviderName, "803846"}},
